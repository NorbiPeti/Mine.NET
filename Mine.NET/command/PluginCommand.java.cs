...
namespace Mine.NET.command
{
    ...
    public sealed class PluginCommand : Command, PluginIdentifiableCommand
    {
        ...
        public override bool execute(CommandSender sender, String commandLabel, String[] args)
        {
            ...
            {
                throw new CommandException("Unhandled exception executing command '" + commandLabel + "' in plugin " + owningPlugin.FullName, ex);
            }
        ...
        public override List<String> tabComplete(CommandSender sender, String alias, String[] args)
        {
            ...
            catch (Exception ex)
            {
                ...
                message.Remove(message.Length - 1, 1).Append("' in plugin ").Append(owningPlugin.FullName);
        ...
        public override string ToString()
        {
            ...
            stringBuilder.Append(", ").Append(owningPlugin.FullName).Append(')');
