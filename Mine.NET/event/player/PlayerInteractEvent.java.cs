...
namespace Mine.NET.Event.player
{
     ...
     */
    public class PlayerInteractEventArgs : PlayerEventArgs, Cancellable
    {
        ...
        public PlayerInteractEventArgs(Player who, Action action, ItemStack item, Block clickedBlock, BlockFaces clickedFace) :
            this(who, action, item, clickedBlock, clickedFace, EquipmentSlot.HAND)
        {
        }

        public PlayerInteractEventArgs(Player who, Action action, ItemStack item, Block clickedBlock, BlockFaces clickedFace, EquipmentSlot hand) :
            base(who)
        {
            this.action = action;
            this.item = item;
        ...
        public bool isBlockInHand()
        {
            ...
            return Material.AllMaterials[item.getType()].isBlock();
        }
