namespace Mine.NET.util.noise
{
    ...
    public class SimplexOctaveGenerator : OctaveGenerator
    {
         ...
         */
        public SimplexOctaveGenerator(World world, int octaves) : this(new JavaRand(world.getSeed()), octaves)
        {
        }
         ...
         * @param octaves Amount of octaves to create
         */
        public SimplexOctaveGenerator(long seed, int octaves) : this(new JavaRand(seed), octaves)
        {
        }
         ...
         * @param octaves Amount of octaves to create
         */
        public SimplexOctaveGenerator(JavaRand rand, int octaves) : base(createOctaves(rand, octaves))
        {
        }
